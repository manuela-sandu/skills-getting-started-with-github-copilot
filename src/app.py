...
activities = {
    ...
    "Track and Field": {
        ...
        "max_participants": 25,
        "participants": ["camila@mergington.edu"]
    },
    "Music Club": {
    ...
    "Dance Club": {
        "description": "Explore various dance styles and put on shows",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["isla@mergington.edu"]
    },
    "History Club": {
        "description": "Discuss historical events, research projects, and field trips",
        "schedule": "Tuesdays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu"]
    },
    "Quiz Bowl": {
        "description": "Team trivia competitions across academic subjects",
